...
#define COCOAPODS_POD_AVAILABLE_UIViewController_HUD
#define COCOAPODS_VERSION_MAJOR_UIViewController_HUD 1
#define COCOAPODS_VERSION_MINOR_UIViewController_HUD 0
#define COCOAPODS_VERSION_PATCH_UIViewController_HUD 0
